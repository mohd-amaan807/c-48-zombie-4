...
textSize(20)
  fill("white")
text("Bullets = " + bullets,displayWidth-250,displayHeight/2-250)
text("Score = " + score,displayWidth-250,displayHeight/2-220)
text("Lives = " + life,displayWidth-250,displayHeight/2-280)
